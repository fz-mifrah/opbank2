...
public class RechargeResource {
    ...
    public ResponseEntity<List<RechargeDTO>> getAllRecharges(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Recharges");
        Page<RechargeDTO> page = rechargeService.findAll(pageable);
