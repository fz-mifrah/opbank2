...
public class PaimentFactureResource {
    ...
    public ResponseEntity<List<PaimentFactureDTO>> getAllPaimentFactures(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of PaimentFactures");
        Page<PaimentFactureDTO> page = paimentFactureService.findAll(pageable);
